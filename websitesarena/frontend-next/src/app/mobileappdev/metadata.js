export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Mobile app development services in Nairobi and across Kenya — iOS, Android, React Native, Flutter, M-Pesa integrations, and app store publishing.',
    type: 'website',
    url: 'https://websitesarena.com/mobile-app-development',
    images: [{ url: '/og-image-mobile.jpg' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Mobile App Development Nairobi | Websites Arena',
    description: 'Mobile app development services in Nairobi and across Kenya — iOS, Android, React Native, Flutter, M-Pesa integrations, and app store publishing.',
    images: ['/og-image-mobile.jpg'],
  },
  alternates: {
    canonical: 'https://websitesarena.com/mobile-app-development',
  },
  schema: {
